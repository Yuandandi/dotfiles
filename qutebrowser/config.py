...
config.bind('0', 'home')
config.bind('dv', 'set downloads.location.directory ~/videos ;; hint links download')
...
config.bind('di', 'set downloads.location.directory ~/images ;; hint links download')
config.bind(';h', 'set downloads.location.directory ~/ ;; hint links download')
config.bind(';dm', 'set downloads.location.directory ~/music ;; hint links download')
