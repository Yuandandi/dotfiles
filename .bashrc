...
alias fl="cd ~/learn; vi (fd | fzf --dct)" # one day last files changed
...
alias fv="cd ~/.vim; and vi (fd -H --exclude lazy-lock.json --exclude .git --exclude .jukit --exclude autoload --exclude undodir| fzf --dct)" # faster config vi
alias fvi="cd ~/.config/vim/; and vi (fd -H --exclude lazy-lock.json --exclude .git --exclude .jukit| fzf --dct)" # faster config vi
alias fw="cd ~/notes; vi (fd | fzf --dct)" # one day last files changed
alias ga='git add'
alias gb='git branch'
alias gc='git commit'
alias gcl='git clone'
...
alias mb='mv'
alias mdkir='mkdir'
alias mega='/home/danzor/Downloads/MegaBasterdLINUX/MegaBasterd.run'
...
alias tr='vi /home/danzor/repos/github.com/yuandandi/notes/translate'
alias t='tail'
alias uniq='uniq -c'
alias untar='tar xvf'
...
alias w='w3m'
alias x='exit'
alias yt='qutebrowser https://youtube.com'
