...
alias rob='wslview https://github.com/rwxrob'
...
alias c='clear'
alias ccl='clear'
alias chat='cmd.exe /c start firefox.exe https://chat.openai.com'
...
alias x='exit'
alias yt='cmd.exe /c start firefox.exe https://youtube.com'
